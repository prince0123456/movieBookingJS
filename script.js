...
function createSeparateMovieTabs(data, wrapper) {
     ...
     mainElement.onmouseover = function (x) {
...
function renderSeats(data) {
     if (booker.firstElementChild.tagName !== "H3") {
          ...
          booker.innerHTML = `<h3 class="v-none">Seat Selector</h3>
                              ...
                              <button id="book-ticket-btn" class="v-none" style="color:black; background-color:white">Book my seats</button>`;
     }
...
function createForm() {
     ...
     let formElements = `<input type="email" id="email" style="color:black;  background-color:white" placeholder="email" required><br><br>
                         <input type="number" id="phone" style="color:black; background-color:white" placeholder="phone" required><br><br>
                         <button id="submitBtn" style="color:black; background-color:white" type="submit">Purchase</button>`;
     form.setAttribute("method", "post");
     form.setAttribute("id", "customer-detail-form");
     // formElements.style = 'color:red;background-color:white';
